...
- [Bionic Jolt (common)](/packages/bionic-jolt-common) - a game project that drives the initial set of features that _wayfare_ should have (3D primitives, collision detection, cameras, etc...).
